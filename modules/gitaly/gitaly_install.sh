...
then
  sed -i "s/# gitlab_rails\['internal_api_url'\] = .*/gitlab_rails\['internal_api_url'\] = 'http://${lb_dns_name}'/" gitlab.rb
elif [[ ${visibility} = "public" ]]
then
  sed -i "s/# gitlab_rails\['internal_api_url'\] = .*/gitlab_rails\['internal_api_url'\] = 'http://${instance_dns_name}'/" gitlab.rb
fi
...
sed -i "s/# gitlab_rails\['listen_addr'\] = .*/gitlab_rails\['listen_addr'\] = \"0.0.0.0:8075\"/" gitlab.rb
